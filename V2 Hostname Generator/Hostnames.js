...
function updateTable() {
  let rows = document.getElementById('tbody')
 ...
 // applying styles 
 let tdStyle= 'border-color: red;color: green;text-align: center;'
  hostname.style= tdStyle;
  serial.style= tdStyle;
  prefix.style= tdStyle;
  make.style= tdStyle;
  model.style= tdStyle;
